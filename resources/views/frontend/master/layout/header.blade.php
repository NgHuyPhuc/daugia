        ...
        <div class="container mg-top-btm-30">
            <div class="row">
                <div class="col-lg-2 col-md-3">
                    <a href="/"><img class="logo-page" src="img/dang-ky-website-dau-gia-truc-tuyen-2.jpg"
                            alt=""></a>
                </div>
                                        ...
                                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="/about" class="">Lịch sử hình thành và phát
                                                            triển</a>
                                                    </li>
                                                    <li>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="{{ route('user.result') }}">Kết
                                                            quả đấu giá</a></li>
                                                    <li>
                                                        <hr class="dropdown-divider">
                                                    </li>
                                                    <li><a class="dropdown-item" href="{{ route('user.result') }}">Hợp
                                                            đồng mua bán tài sản</a>
                                                    </li>
                                                    <li>
                                                        <hr class="dropdown-divider">
                                                    </li>
                                                    <li><a class="dropdown-item" href="{{ route('user.result') }}">Bàn
                                                            giao tài sản</a></li>
                                                    <li>
                                                        <hr class="dropdown-divider">
                                                    </li>
                                                    <li><a class="dropdown-item" href="{{ route('user.result') }}">Hỗ
                                                            trợ giao hàng</a></li>
                                                </ul>
                                            </li>
                                            @if (Auth::check('web'))
                                                <li class="nav-item">
                                                    <a class="nav-link mt-30 nav-name"
                        ...
                        <ul class="menu-ul">
                            ...
                            <li class="">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="{{ route('user.result') }}" class="">Hợp đồng mua bán tài
                                            sản</a></li>
