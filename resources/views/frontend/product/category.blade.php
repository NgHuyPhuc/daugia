                        ...
                        <div class="category-main mb-30">
                            ...
                            <div class="category-list">
                                @foreach ($allcategory as $item)
                                    <a href="{{ route('site.category', ['slug' => $item->slug] ) }}" class="category-item">
                                        {{$item->name}}
                                    </a>
        ...
        <div class="row">
            <div class="col-lg-12 pt-30">
                <div id="nav-tab" role="tablist" class="nav nav-tabs">
                    <a href="" class="nav-item nav-link active">DANH SÁCH {{$categories->name}}</a>
                </div>
                ...
                <div class="custom-pagination">
                    {{$allproduct->links('frontend.pagination.pagination')}}
                </div>
            </div>
        </div>
    </div>
