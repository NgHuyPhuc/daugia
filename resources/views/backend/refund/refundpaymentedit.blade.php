                            ...
                            <div class="row" style="margin-bottom:40px">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$payment->id_user }}" type="text" name="id_user" class="form-control" disabled>
                                        <label> <a target="_blank" href="{{route('useradminsite.detail',['id' => $payment->id_user])}}">{{$payment->user->name }} </a></label>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$payment->bank_account_number}}" type="text" name="bank_account_number" class="form-control" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>Tên ngân hàng</label>
                                        <input value="{{$payment->bank}}" type="text" name="bank_account_number" class="form-control" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>Tên chủ tài khoản ngân hàng</label>
                                        <input value="{{$payment->account_holder_name}}" type="text" name="bank_account_number" class="form-control" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>Tổng tiền thanh toán</label>
                                        <input value="{{$payment->total_amount}}" type="text" name="total_amount" class="form-control" disabled>
                                    </div>
                                    <div class="form-group">
