                            ...
                            <div class="row" style="margin-bottom:40px">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="city_province" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Bước giá</label>
                                        <input type="number" name="price_step" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Chi phí tham gia</label>
                                        <input type="number" name="participation_costs" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Tiền đặt cọc</label>
                                        <input type="number" name="auction_deposit" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="registration_time" class="form-control">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="more_description" style="width: 100%;height: 100px;"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
