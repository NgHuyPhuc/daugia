...
@section('title', 'Danh sách đơn hàng hoàn tiền')
@section('main')
                            ...
                            <table class="table table-bordered" style="margin-top:20px;">
                                ...
                                @foreach ($payments as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('paymentstate.edit',['id' => $item->id])}}" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> Sửa</a>
                                            <a href="{{route('paymentstate.delete',['id' => $item->id])}}" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
                                        </td>
                                    </tr>
                                @endforeach
