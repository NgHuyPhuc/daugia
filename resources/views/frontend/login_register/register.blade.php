                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="password" class="form-control" id="form-password" placeholder="Nhập mật khẩu" required>
                        </div>
                        <div class="form-group">
                            <label for="form-password">Xác nhận mật khẩu</label><code>*</code>
                            <input type="text" name="repassword" class="form-control" id="form-password" placeholder="Nhập mật khẩu" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phonenumber" class="form-control" id="form-phone" placeholder="Số điện thoại" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label for="form-cmnd">Số CMND/CCCD</label><code>*</code>
                            <input type="text" name="cmndnumber" class="form-control" id="form-cmnd" placeholder="Số CMND" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
                        </div>
                        <div class="form-group">
                            <label for="form-date-cmnd">Ngày Cấp CMND/CCCD</label><code>*</code>
                            <input type="date" name="datecmnd" class="form-control" id="form-noi-cap-cmnd" required>
                        </div>
                        <div class="form-group">
                            <label for="form-noi-cap-cmnd">Nơi cấp CMND/CCCD</label><code>*</code>
                            <input type="text" name="noicapcmnd" class="form-control" id="form-date-cmnd" placeholder="Nơi cấp" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="img2" type="file" name="image" class="form-control hidden" onchange="changeImg2(this)">
